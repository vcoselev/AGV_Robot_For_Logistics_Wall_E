...
void QTRSensors::setTypeAnalog()
{
  ...
  _maxValue = 4095; // Arduino analogRead() returns a 12-bit value by default
}
...
void QTRSensors::setMultPins(uint8_t sel_0, uint8_t sel_1)
{
  SEL0 = sel_0;
  SEL1 = sel_1;
...
void QTRSensors::multiplex( uint8_t i)
{
  switch (i)
  {
    case 0:
